...
fn new() -> PlotWidget {
    ...
    PlotWidgetBuilder::new()
        ...
        .with_x_tick_producer(|min, max, width_px| log_tick_producer(E, min, max, width_px))
        .with_y_tick_producer(|min, max, height_px| log_tick_producer(E, min, max, height_px))
